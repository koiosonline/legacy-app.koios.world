  ...
  return (
    <>
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(to right, rgba(255, 11, 172, 0.5), rgba(47, 18, 220, 0.5)), url(${currentVacancy.imageUrl})`,
        }}
      >
        ...
        <div className={"content"}>
          ...
          <ul className={"content__typeList"}>
            {currentVacancy.type.map((types, index) => {
              return <li key={index}>{types.typeItem}</li>;
            })}
          </ul>
          <div className={"content__buttonContainer"}>
            <a className={"content__button"} href={defaultInfo.form_link}>
              I'm interested!
            </a>
          </div>
        </div>
      ...
      <div className={"defaultInfo"}>
        ...
        <div className={"block"}>
          ...
          <a className={"block__url"} href={defaultInfo.website}>
            Koios world
          </a>
        </div>
        ...
        <div className={"block"}>
          <h2 className={"block__title"}>
            Is the organization prepared to sign a contract with you, if required or preferred by you?
          </h2>
        ...
        <div className={"block"}>
          ...
          <div className={"block__discord"}>
            <a className={"block__link"} href={defaultInfo.contact_info}>
              <span>Find us in the Discord:</span> <img src={"./images/Discord-Logo-Black.svg"} alt={"discord"} />
            </a>
            <p className={"block__description--discord"}>
              <span>And contact user:</span> Jordi Jansen #3497
            </p>
          </div>
        </div>
