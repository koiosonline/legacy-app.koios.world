const ABI = [
  ...
  {
    inputs: [{ internalType: 'contract ERC20Burnable', name: '_newTokenAddress', type: 'address' }],
    name: '_setContractToken',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
    ...
    outputs: [
      {
        ...
        internalType: 'struct Koios.KekwToken[]',
        name: '',
        type: 'tuple[]',
      },
    ],
  ...
  { inputs: [], name: 'toggleRevealed', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
