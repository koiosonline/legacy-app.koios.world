    ...
    <>
      ...
      <div className={"quizContainer__content"}>
        <div className={"modalContainer__content__closeButton"} onClick={props.modalState}>
          <Icon className="ModalContainer__content__closeButton__close" type={"close" as keyof typeof SvgSprite} />
        </div>
        ...
        <h2 className={"quizContainer__content__subtitle"}>
          {data.multipleAnswers ? "*Multiple answers are possible" : ""}
        </h2>
        <div className={"quizContainer__content__answers"}>
          ...
          {congrats && (
            <div className={"quizContainer__content__congrats"}>
              <button onClick={props.modalState} className={"quizContainer__content__congrats__button"}>
                <p>Continue</p>
              </button>
            </div>
          )}
